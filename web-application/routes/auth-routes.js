...
// приглашает бота в главном меню
router.get('/invite-bot', (req, res) =>
  res.redirect(`https://discord.com/api/oauth2/authorize?client_id=${config.bot.id}&redirect_uri=${config.dashboardURL}/&response_type=code&scope=bot`));

// приглашает бота в панели управления
router.get('/invite-dashboard', (req, res) =>
...
router.get('/auth', async (req, res) => {
  try {
    ...
    res.redirect('/auth-guild'); // исправил - было /dashboard
  } catch {
    res.redirect('/');
  }
});
